...
import { Citation, SterlingRay4BassCard, SchecterGuitarStudioBassCard, YamahaTrbx305BassCard, SilverCreekBassCard } from '../component-exports';
import { Behringer5ChannelCard, FocusriteScarlettCard, KustomPaCard, GuitarWarranty, DAngelicoCard, FreeShipping } from '../component-exports';
import { AddReview, ReviewerList, UpdateReviewForm } from '../component-exports';
import bassSpecs from './bass-specs';


const FenderTonyFranklinBassPage = () => {
    ...
    return (
        <div>
            <h1 className="text-center sub-page-heading">Fender Tony Franklin Fretless Precision Bass </h1>

            <div className="product-row">
                <img src={process.env.PUBLIC_URL + '/Basses-images/Fender Tony Franklin Fretless Precision Bass 3-Color Sunburst.jpg'} alt="guitar" className="product-img-page" />
                <div className="product-column">
                    <h2 className="product-price text-center">$1,999.99</h2>
                    <InStock />
                    <OrderTemplate />
                </div>
            </div>
            ...
            <div className="card-title">
                <p>
                    The Tony Franklin Fretless Precision Bass guitar is built with input from the bassist who has
                    played with the Firm, Whitesnake, David Gilmour, and many others.
                </p>
                <p>
                    It has an alder body and a modern C-shaped maple neck with an unfinished,
                    unfretted ebony fingerboard with side dot position markers.
                    That trademark growl comes from an American Series Precision Bass neck pickup and a
                    Tony Franklin signature Jazz Bass bridge pickup with hex screw lugs and bar ceramic
                    magnets. Other features include vintage tuning machines with a Hipshot Bass Xtender
                    Drop D tuning key on the "E" string to get way down low,
                    and three-way switching for maximum tonal choices.
                </p>
                <Citation />
            </div>
...
export default FenderTonyFranklinBassPage;