...
import { Citation, IbanezBassCard, SchecterGuitarStudioBassCard, YamahaTrbx305BassCard, RogueLx205BassCard } from '../component-exports';
import { FenderRUMBLECard, Mxl990MicCard, ZoomHandyVideoRecorderCard, Line6HelixCard, GuitarWarranty, FreeShipping } from '../component-exports';
import { AddReview, ReviewerList, UpdateReviewForm } from '../component-exports';
import bassSpecs from './bass-specs';


const CremonaSb3BassPage = () => {
    ...
    return (
        <div>
            <h1 className="text-center sub-page-heading">Cremona SB-3 Upright Bass 3/4</h1>

            <div className="product-row">
                <img src={process.env.PUBLIC_URL + '/Basses-images/Cremona SB-3 Upright Bass.jpg'} alt="guitar" className="product-img-page" />
                <div className="product-column">
                    <h2 className="product-price text-center">$1,499.99</h2>
                    <InStock />
                    <OrderTemplate />
                </div>
            </div>
            ...
            <div className="card-title">
                <p>
                    This is America's best value in a flamed maple bass.
                </p>
                <p>
                    With its beautiful violin-shaped body and quality fittings such as the ebony fingerboard,
                </p>
                <p>
                    you will surely be noticed wherever you and your bass might go.
                    Includes gig bag.
                </p>
...
export default CremonaSb3BassPage;